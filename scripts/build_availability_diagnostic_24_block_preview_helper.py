# -*- coding: utf-8 -*-
"""Build deterministic Phase 27 availability + 24-block preview."""
...
def build_availability_diagnostic_24_block_preview_helper() -> dict[str, object]:
    ...
    summary["recommendation"] = "AVAILABILITY_DIAGNOSTIC_24_BLOCK_PREVIEW_READY" if summary.get("command_status") == "REAL_MATCH_ANALYSIS_COMMAND_PREVIEW_READY" else "BUILD_AVAILABILITY_DIAGNOSTIC_24_BLOCK_PREVIEW"
    return summary
