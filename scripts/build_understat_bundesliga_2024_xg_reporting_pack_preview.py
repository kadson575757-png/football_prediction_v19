# -*- coding: utf-8 -*-
"""Build and audit the Bundesliga 2024 xG reporting pack preview."""
...
from audit_xg_reporting_pack_preview import run as run_audit  # noqa: E402
...
def run_workflow(manifest: str | Path, output_dir: str | Path, *, window: int = 5) -> dict[str, object]:
    ...
    _table, _markdown, rec = run_audit(
        index=summary.get("reporting_pack_index_path") or None,
