# -*- coding: utf-8 -*-
"""Build and audit Bundesliga 2024 analysis export bundle preview."""
...
from audit_analysis_export_bundle_preview import run as run_audit  # noqa: E402
from build_analysis_export_bundle_preview import build_analysis_export_bundle_preview  # noqa: E402
...
def run_workflow(manifest: str | Path, output_dir: str | Path, *, window: int = 5) -> dict[str, object]:
    ...
    _table, _markdown, rec = run_audit(
        index=summary.get("export_bundle_index_path") or None,
