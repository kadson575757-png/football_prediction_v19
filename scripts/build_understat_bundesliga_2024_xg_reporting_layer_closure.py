# -*- coding: utf-8 -*-
"""Build and audit Bundesliga 2024 xG reporting layer closure."""
...
from audit_xg_reporting_layer_closure import run as run_closure, summarize_closure  # noqa: E402
...
def run_workflow(manifest: str | Path, preview_dir: str | Path, output_dir: str | Path, *, window: int = 5) -> dict[str, object]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = run_workflow(args.manifest, args.preview_dir, args.output_dir, window=args.window)
    for key in [
        "closure_status",
        "manifest_id",
