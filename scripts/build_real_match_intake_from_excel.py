...
def build_real_match_intake_from_excel(
    *,
    ...
    _finalize_quality(row, evidence)
...
def _finalize_quality(row: dict[str, object], evidence: list[ExcelEvidence]) -> None:
    ...
    row["evidence_quality_note"] = "Generated from local Excel evidence; missing values remain blank and require manual review."
