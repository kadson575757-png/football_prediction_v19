...
def build_human_24_block_report_preview(*, context_human_input_path: str | Path | None = None, v19_diagnostic_synthesis_path: str | Path | None = None, v19_diagnostic_gate_matrix_path: str | Path | None = None, market_movement_diagnostic_path: str | Path | None = None, output_dir: str | Path = ROOT / "outputs" / "analysis_preview" / "human_24_block_report", base_dir: str | Path = ROOT, build_missing: bool = True) -> dict[str, object]:
