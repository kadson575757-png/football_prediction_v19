# -*- coding: utf-8 -*-
"""Build and audit offline Understat provider pull preview."""
...
from audit_understat_provider_pull_preview import run as run_audit  # noqa: E402
...
def run_workflow(output_dir: str | Path) -> dict[str, object]:
    ...
    summary = build_understat_provider_pull_preview(league="Bundesliga", season="2024", input_path=fixture, output_dir=output_dir, allow_network=False, write_preview=True, base_dir=base_dir)
    ...
    return {**summary, "understat_provider_pull_status": summary["provider_pull_status"], "recommendation": rec}
...
def main(argv: list[str] | None = None) -> int:
    ...
    for key in ["understat_provider_pull_status", "provider", "league", "season", "rows_normalized", "network_calls_enabled", "recommendation"]:
