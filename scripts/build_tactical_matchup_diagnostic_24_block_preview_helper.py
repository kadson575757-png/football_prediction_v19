# -*- coding: utf-8 -*-
"""Build deterministic Phase 29 tactical matchup + 24-block preview."""
...
def build_tactical_matchup_diagnostic_24_block_preview_helper() -> dict[str, object]:
    ...
    summary["recommendation"] = "TACTICAL_MATCHUP_DIAGNOSTIC_24_BLOCK_PREVIEW_READY" if summary.get("command_status") == "REAL_MATCH_ANALYSIS_COMMAND_PREVIEW_READY" and int(summary.get("sheets_written", 0) or 0) >= 16 else "BUILD_TACTICAL_MATCHUP_DIAGNOSTIC_24_BLOCK_PREVIEW"
    return summary
