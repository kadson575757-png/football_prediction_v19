...
def main(argv: list[str] | None = None) -> int:
    ...
    for key in ["match_analysis_runner_status", "match_context_bundle_status", "context_bridge_status", "human_24_block_report_status", "understat_provider_match_id", "fbref_provider_match_id", "cross_provider_match_key", "home_team", "away_team", "match_date", "rows_joined", "rows_written", "rows_reported", "sections_rendered", "report_output_path", "network_calls_enabled", "prediction_logic_enabled", "betting_logic_enabled", "recommendation"]:
