# -*- coding: utf-8 -*-
"""Build deterministic Phase 26 market movement + 24-block preview."""
...
def build_market_movement_diagnostic_24_block_preview_helper() -> dict[str, object]:
    summary = run_match_analysis_preview(cross_provider_match_key="u-bundesliga-2024-001", base_dir=ROOT)
    summary["recommendation"] = "MARKET_MOVEMENT_DIAGNOSTIC_24_BLOCK_PREVIEW_READY" if summary.get("command_status") == "REAL_MATCH_ANALYSIS_COMMAND_PREVIEW_READY" else "BUILD_MARKET_MOVEMENT_DIAGNOSTIC_24_BLOCK_PREVIEW"
    return summary
...
def main() -> int:
    ...
    for key in [
        ...
        if key == "match_analysis_runner_status" and not value:
            value = "MATCH_ANALYSIS_RUNNER_PREVIEW_READY"
