...
def main(argv: list[str] | None = None) -> int:
    ...
    for key in [
        ...
        "production_readiness_report_path", "v19_production_readiness_gate_status",
        "production_readiness_gate_enabled", "decision_promotion_preview_enabled",
        "final_decision_class", "promotion_allowed", "strong_promotion_allowed",
        "conflict_score",
