...
def build_combined_indicator_shadow_mix(
    ...
    max_total_shift: float = 0.08,
) -> dict[str, object]:
    return _build_mix("combined_mix", base_home_probability, base_draw_probability, base_away_probability, indicator_results, weights, max_total_shift, COMBINED_PREFIX_BY_NAME)
