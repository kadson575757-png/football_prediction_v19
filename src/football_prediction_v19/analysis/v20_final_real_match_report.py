...
def write_v20_final_real_match_report(result: dict[str, object], output_dir: str | Path) -> str:
    ...
    lines = [
        ...
        *_source_lines(result),
        ...
        "Odds unavailable because no API key was provided; in v2.0.1 this is optional and cannot by itself create DATA_BLOCKED.",
        ...
        "## 18. What Would Improve Confidence", "More source coverage, fresh cache, lineups and injuries. Odds snapshots can improve confidence but are optional.",
