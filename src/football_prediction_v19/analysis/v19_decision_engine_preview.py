...
def _market_family_read(row: dict[str, object], blockers: list[str]) -> list[dict[str, str]]:
    ...
    return [
        ...
        {"market_family": "Over/Under", "status": "PARTIAL", "analyst_lean": "OVER_LEAN", "confidence_band": "LOW", "reason": "Both teams have plausible scoring routes, but recent form and big chances are missing.", "blockers": "Recent Form | Big Chances | DNB/OU Market"},
