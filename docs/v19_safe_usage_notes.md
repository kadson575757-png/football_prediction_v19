# v1.9 Safe Usage Notes

Synthetic fixtures are not real match data. Demo packs are marked with `synthetic_demo_pack=true`, `not_real_match_data=true`, and `not_for_prediction=true`.
