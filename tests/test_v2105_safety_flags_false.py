...
def test_v2105_safety_flags_false(monkeypatch, tmp_path):
    ...
    for name in ["build_draw_tendency_indicator", "build_venue_result_rate_indicator", "build_goal_margin_profile_indicator", "build_venue_scoring_balance_indicator", "build_clean_sheet_failed_to_score_indicator", "build_rest_days_congestion_indicator", "build_table_strength_gap_indicator", "build_comeback_blown_lead_indicator"]:
